    ...
    <main class="max-w-md mx-auto px-6 py-8">
      <header class="mb-8">
        ...
        <div class="mt-3 flex items-center justify-between">
          ...
          <div class="flex items-center gap-2">
            <NuxtLink to="/targets" class="w-10 h-10 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-400 hover:bg-emerald-500 hover:text-slate-900 transition-all shadow-lg shadow-emerald-500/10 group/target" title="목표가 모아보기">
