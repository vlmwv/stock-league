      ...
      <section v-if="recommendedStocks && recommendedStocks.length > 0" class="px-4 mb-10 relative group/ai-section">
        <div class="flex justify-between items-end mb-4 px-2">
          ...
          <div class="flex items-center gap-3">
            <NuxtLink to="/ai?sub=target" class="w-8 h-8 rounded-xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-400 hover:bg-emerald-500 hover:text-slate-900 transition-all shadow-lg shadow-emerald-500/10 group/target" title="목표가 모아보기">
