...
- [x] 최종 검증 및 배포
    ...
    - [x] 게임 시작 버튼 및 상/하 스와이프 인터랙션 구현
    - [x] 헤더 내 뉴스 알림 드롭다운 UI 구현
    - [x] KST 날짜 헬퍼 함수 통합 및 로직 일관성 확보
    - [x] Railway 배포 시 Mock 데이터 노출 현상 수정 (데이터 부재 시 최신 데이터로 폴백)
- [x] 프로젝트 최종 마무리 (README 업데이트 및 커스텀 도메인 안내)
- [x] 서비스 유지보수 및 버그 수정
    - [x] Gemini API 404/429 할당량 에러 해결 (`gemini-2.5-flash` 모델로 업데이트 및 배포)
    - [x] 메인 홈 화면(`index.vue`) 장식용 UI 컨테이너 위치 수정
