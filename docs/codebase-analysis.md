...
| 🟡 | 🔄 | **테스트/린트/타입체크** — 스택·스크립트·스타터 테스트 도입(설치/실행은 환경 필요) | 프로젝트 전반 | 회귀 방어선 없음 |
...
10. 🔄 **(저) 테스트/린트/타입체크 도입** — Nuxt 4 표준 스택(vitest·@nuxt/eslint·vue-tsc) + 스크립트 + 스타터 테스트 도입. 설치/실행·점진 강화는 환경 필요(remaining-issues.md §7).
